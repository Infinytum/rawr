...
"""
Plain Text#hashtags@username@instance.tld$[x2 Double Size Modifier][Named URL](https://example.com)**A bold claim**<center><small><i>Italic, small and centered</i></small></center>https://example.com
"""
        )).scaleEffect(0.5)
    }
